...
@interface FlutterLockerApiCodecReader : FlutterStandardReader
@end
@implementation FlutterLockerApiCodecReader
...
@interface FlutterLockerApiCodecWriter : FlutterStandardWriter
@end
@implementation FlutterLockerApiCodecWriter
...
@interface FlutterLockerApiCodecReaderWriter : FlutterStandardReaderWriter
@end
@implementation FlutterLockerApiCodecReaderWriter
- (FlutterStandardWriter *)writerWithData:(NSMutableData *)data {
  return [[FlutterLockerApiCodecWriter alloc] initWithData:data];
}
- (FlutterStandardReader *)readerWithData:(NSData *)data {
  return [[FlutterLockerApiCodecReader alloc] initWithData:data];
}
@end

NSObject<FlutterMessageCodec> *FlutterLockerApiGetCodec() {
  static dispatch_once_t sPred = 0;
  static FlutterStandardMessageCodec *sSharedObject = nil;
  dispatch_once(&sPred, ^{
    FlutterLockerApiCodecReaderWriter *readerWriter = [[FlutterLockerApiCodecReaderWriter alloc] init];
...
void FlutterLockerApiSetup(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FlutterLockerApi> *api) {
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.FlutterLockerApi.canAuthenticate"
        binaryMessenger:binaryMessenger
        codec:FlutterLockerApiGetCodec()        ];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(canAuthenticateWithCompletion:)], @"FlutterLockerApi api (%@) doesn't respond to @selector(canAuthenticateWithCompletion:)", api);
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.FlutterLockerApi.save"
        binaryMessenger:binaryMessenger
        codec:FlutterLockerApiGetCodec()        ];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(saveRequest:completion:)], @"FlutterLockerApi api (%@) doesn't respond to @selector(saveRequest:completion:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.FlutterLockerApi.retrieve"
        binaryMessenger:binaryMessenger
        codec:FlutterLockerApiGetCodec()        ];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(retrieveRequest:completion:)], @"FlutterLockerApi api (%@) doesn't respond to @selector(retrieveRequest:completion:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.FlutterLockerApi.delete"
        binaryMessenger:binaryMessenger
        codec:FlutterLockerApiGetCodec()        ];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(deleteKey:completion:)], @"FlutterLockerApi api (%@) doesn't respond to @selector(deleteKey:completion:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
