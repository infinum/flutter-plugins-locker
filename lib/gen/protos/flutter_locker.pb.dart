...
class ProtoAndroidPrompt extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ProtoAndroidPrompt', createEmptyInstance: create)
  ...
  ProtoAndroidPrompt copyWith(void Function(ProtoAndroidPrompt) updates) => super.copyWith((message) => updates(message as ProtoAndroidPrompt));
...
class ProtoIOsPrompt extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ProtoIOsPrompt', createEmptyInstance: create)
  ...
  ProtoIOsPrompt copyWith(void Function(ProtoIOsPrompt) updates) => super.copyWith((message) => updates(message as ProtoIOsPrompt));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ProtoSaveRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ProtoSaveRequest', createEmptyInstance: create)
    ..aOS(1, 'key')
    ..aOS(2, 'secret')
  ...
  ProtoSaveRequest copyWith(void Function(ProtoSaveRequest) updates) => super.copyWith((message) => updates(message as ProtoSaveRequest));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ProtoRetrieveRequest extends $pb.GeneratedMessage {
  ...
  ProtoRetrieveRequest copyWith(void Function(ProtoRetrieveRequest) updates) => super.copyWith((message) => updates(message as ProtoRetrieveRequest));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ProtoDeleteRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ProtoDeleteRequest', createEmptyInstance: create)
    ..aOS(1, 'key')
    ..hasRequiredFields = false
  ;
